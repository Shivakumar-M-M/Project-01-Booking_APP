...
export default function BookingsPage() {
    ...
    return (
        <div>
            ...
            <div>
                {bookings?.length > 0 ? (
                    bookings.map(booking => (
                        <Link to={`/account/bookings/${booking._id}`} key={booking._id} className="flex gap-4 my-5 bg-gray-200 rounded-2xl">
                            <div className="w-48">
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 8.25h19.5M2.25 9h19.5m-16.5 5.25h6m-6 2.25h3m-3.75 3h15a2.25 2.25 0 0 0 2.25-2.25V6.75A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25v10.5A2.25 2.25 0 0 0 4.5 19.5Z" />
                 ...
                 Total Price : $ {booking.price}
                    ...
                    <div className=" flex w-auto text-center justify-center p-2 bg-red-500  text-white rounded-2xl">
                        <div>
                            Oops! No Bookings Available
</div>
                    </div>
                )}
            </div>
